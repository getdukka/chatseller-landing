...
const translations: Record<Language, Translations> = {
  fr: {
    ...
    footerRevolutionizing: 'TEKKI GROUP • Dakar, Sénégal 🇸🇳 • Révolutionnant l\'e-commerce en Afrique',
  ...
  en: {
    ...
    solutionTestFree: 'Test ChatSeller Free',
    ...
    footerRevolutionizing: 'TEKKI GROUP • Dakar, Senegal 🇸🇳 • Revolutionizing e-commerce in Africa',
    footerAbout: 'About',
    footerSupport: 'Support & FAQ',
